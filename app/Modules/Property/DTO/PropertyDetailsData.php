...
class PropertyDetailsData extends Data
{
    ...
    public function __construct(
        ...
        #[DataCollectionOf(LeaseData::class)]
        public ?DataCollection $active_leases,
    ...
    public static function fromModel(Property $property): self
    {
        ...
        return new self(
            ...
            active_leases: LeaseData::collect($property->activeLeases, DataCollection::class)
            ?? null,
